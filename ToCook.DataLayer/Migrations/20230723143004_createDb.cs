    ...
    public partial class createDb : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UseresRoles", x => x.UR_Id);
                    table.ForeignKey(
                        name: "FK_UseresRoles_Roles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "Roles",
                        principalColumn: "RoleId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UseresRoles_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UseresRoles_RoleId",
                table: "UseresRoles",
                column: "RoleId");

            migrationBuilder.CreateIndex(
                name: "IX_UseresRoles_UserId",
                table: "UseresRoles",
                column: "UserId");
        }
